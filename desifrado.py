...
class Aplicacion:
    ...
    def __init__(self, ventana):
        ...
        #atributos
        Label(self.ventana,text="Mensaje a descifrar: ").grid(row=0,column=0)
        self.mensaje = Entry(self.ventana, width=50)
        self.mensaje.grid(row=0,column=1, padx=10, pady=10, ipadx=20, ipady=15)
        
        boton = ttk.Button(self.ventana, text="Desencriptar", command=self.desencriptar).grid(row=2, columnspan=2)
        Label(self.ventana,text="Mensaje descifrado: ").grid(row=3,column=0)
    ...
    def desencriptar(self):
        ...
        print(msg)
        encr = Cifrado_XOR().decrypt_string(msg, key)
